...
//     </head>
//     <body>
//     <h2>Your feedback is important then you think!</h2>
//       <div class="message">
//         <p>Hello {name}</p>
//         <p>We value your feedback and input! It's time to fill out the appraisal form for the period: <span class="date1">{appraisalPeriodT} -- {appraiselPeriodF}</span>.</p>
...
//         <p>
//           <a class="button" href="http://localhost:3000/formDetail">Fill Appraisal Form</a>
//         </p>
//         <span class="date2">Last date to fill Form {appraisalDate}</span>
//       </div>
