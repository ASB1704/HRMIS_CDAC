...
const SelfAppraisalForm = () => {
    ...
    const DynamicRowAddition = () => {
        ...
        return (
          <div className='parent_jasa'>
            <h4 className='title_ja_sa'>Job Assignments and Specific Achievements</h4>
            {rows.map((row, index) => (
              <div key={index} className="row-container">
                ...
                />
                        ...
                        {rows.length === 0 && <div className='initial_msg'>Click on Add button to start adding your data</div>}

            <div className='parent_jasa_btn'>
            <button className="btn_ja_sa"onClick={addRow}>Add</button>
      ...
      const DynamicRowAddition2 = () => {
        ...
        return (
          <div className='parent_jasa'>
            <h4 className='title_ja_sa'>Achievements beyond normal scope of work</h4>
            {rows.map((row, index) => (
              <div key={index} className="row-container">
                <div className="serial-number">{row.serialNumber} </div>
                <input
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Submitted:', { name, employeeid, period, projectname, achievement1 });
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <button className="last_btn"type="submit">Submit</button>
            </div>
            </div>
            </div>
