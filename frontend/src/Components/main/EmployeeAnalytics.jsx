        ...
        return (
            <div className="EAC-extra-details-row-td">
                <div className="EAC-extra-details-row-td-1">
                    ...
                    <p>Technical Knowledge & skills, demonstrates originality & Quality of work done : {curuser.quarter[index].scoreOfEvaluation.sc1}</p>
                    <p> Possess Conceptual Ability. Analyzes problem effectively & finds creative solution to problems : {curuser.quarter[index].scoreOfEvaluation.sc2}</p>
                    <p>Shows interest in work, learns quickly & Takes initiative : {curuser.quarter[index].scoreOfEvaluation.sc3}</p>
                    <p>Punctuality, Behavior & Professional Attitude : {curuser.quarter[index].scoreOfEvaluation.sc4}</p>
                    <p>Open to Criticism & Able to work well with others : {curuser.quarter[index].scoreOfEvaluation.sc5}</p>
                    <p>Communication Skills - oral and written : {curuser.quarter[index].scoreOfEvaluation.sc6}</p>
                </div>
                <div className="EAC-extra-details-row-td-2">
                    <p><strong>Remark :</strong> {curuser.quarter[index].remark} </p>
                    <p><strong>Employee Final Remark :</strong> {curuser.quarter[index].employeeFinalRemark}</p>
